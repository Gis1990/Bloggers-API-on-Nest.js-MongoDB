...
import { EmailRecoveryCodeClass, UserAccountEmailClass } from "../users/users.schema";
...
export class AuthService {
    ...
    async createUser(dto: InputModelForCreatingNewUser, isConfirmed: boolean): Promise<NewUserClassResponseModel> {
